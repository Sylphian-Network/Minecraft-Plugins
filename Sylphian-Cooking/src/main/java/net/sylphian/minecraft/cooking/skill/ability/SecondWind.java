...
/**
 * Active ability unlocked at level 15. Instantly completes the cook at the targeted station.
 */
public final class SecondWind implements ActiveAbility {

    /** Cooldown key used with {@link CooldownManager}. */
    public static final String COOLDOWN_ID = "cooking:second-wind";
    ...
    @Override public String name()        { return "Second Wind"; }
    @Override public String description() { return "Instantly finishes the cook at the station."; }
