package net.sylphian.minecraft.foraging;
...
public final class SylphianForaging extends JavaPlugin {

    private static final String NAMESPACE = "sylphian-foraging";

    private ForagingItemProvider itemProvider;
    ...
    public void onEnable() {
        ...
        new SylphianForagingCommand(this).register();

        getLogger().info("Sylphian Foraging enabled! [" + nodeTypes.size() + " node type(s) loaded]");
    }
    ...
    public void onDisable() {
        ...
        getLogger().info("Sylphian Foraging disabled.");
    }
    ...
    public void reload(CommandSender sender) {
        try {
            ...
            sender.sendMessage(MiniMessage.miniMessage().deserialize(
                    "<green>Sylphian-Foraging reloaded [" + nodeTypes.size() + " node type(s)]."));
        } catch (Exception e) {
