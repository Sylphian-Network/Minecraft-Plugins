...
/**
 * JDBI DAO for the sylphian_skills_progress table.
 */
...
public interface SkillDao {
     ...
     */
    @SqlQuery("SELECT skill_id, xp FROM sylphian_skills_progress WHERE player_uuid = :uuid")
     ...
     */
    @SqlQuery("SELECT xp FROM sylphian_skills_progress WHERE player_uuid = :uuid AND skill_id = :skillId")
     ...
     */
    @SqlUpdate("""
        INSERT INTO sylphian_skills_progress (player_uuid, skill_id, xp)
