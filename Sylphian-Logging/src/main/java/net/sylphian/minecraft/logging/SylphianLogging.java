package net.sylphian.minecraft.logging;
...
import net.sylphian.minecraft.logging.command.SylphianLoggingCommand;
import net.sylphian.minecraft.logging.config.NodeTypeConfigLoader;
import net.sylphian.minecraft.logging.item.LoggingItemProvider;
import net.sylphian.minecraft.logging.skill.SkillsBridge;
...
public final class SylphianLogging extends JavaPlugin {

    private static final String NAMESPACE = "sylphian-logging";

    private LoggingItemProvider itemProvider;
    ...
    public void onEnable() {
        ...
        itemProvider = new LoggingItemProvider(getConfig().getConfigurationSection("items"), getLogger());
        ...
        new SylphianLoggingCommand(this).register();

        getLogger().info("Sylphian Logging enabled! [" + nodeTypes.size() + " node type(s) loaded]");
    }
    ...
    public void onDisable() {
        ...
        getLogger().info("Sylphian Logging disabled.");
    }
    ...
    public void reload(CommandSender sender) {
        try {
            ...
            sender.sendMessage(MiniMessage.miniMessage().deserialize(
                    "<green>Sylphian-Logging reloaded [" + nodeTypes.size() + " node type(s)]."));
        } catch (Exception e) {
